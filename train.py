...
parser.add_argument('--train_data_dir', default='data', type=str, help='training data path')
parser.add_argument('--val_data_dir', default='data', type=str, help='validation data path')
